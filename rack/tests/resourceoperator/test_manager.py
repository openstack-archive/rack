...
class ResourceOperatorManagerNetworkTestCase(test.NoDBTestCase):
    ...
    def test_create_network(self):
        self.stubs.Set(
            self.manager.network_client, "network_create", fake_network_create)
    ...
    def test_create_network_exception_create_faild(self):
        ...
        self.manager.network_client.network_create(
            mox.IsA(str), mox.IsA(str), mox.IsA(str), mox.IsA(str),
            mox.IsA(str),)\
            .AndRaise(Exception())
        self.mox.StubOutWithMock(db, "network_update")
    ...
    def test_delete_network(self):
        ...
        self.mox.StubOutWithMock(self.manager.network_client,
                                 "network_delete")
        self.manager.network_client.network_delete(
            NEUTRON_NETWORK_ID, ext_router)
        self.mox.ReplayAll()

        self.manager.network_delete(
            self.context, NEUTRON_NETWORK_ID, ext_router)
...
class ResourceOperatorManagerSecuritygroupTestCase(test.NoDBTestCase):
    ...
    def test_securitygroup_create(self):
        ...
        self.stubs.Set(self.manager.securitygrouprule_client,
                       "securitygrouprule_create",
                       fake_securitygrouprule_create)
    ...
    def test_securitygroup_delete(self):
        self.mox.StubOutWithMock(
            self.manager.securitygroup_client, "securitygroup_delete")
