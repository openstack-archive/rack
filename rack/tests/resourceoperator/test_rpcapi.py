...
class ResourceOperatorRpcAPITestCase(test.NoDBTestCase):
    def _test_operator_api(self, method, rpc_method, version=None,
        ...
        self.assertEqual(rpcapi.client.target.topic, CONF.resourceoperator_topic)
    ...
    def test_keypair_create(self):
        self._test_operator_api('keypair_create', rpc_method='cast',
                host='fake_host', gid='fake_gid', keypair_id='fake_keypair_id', name='fake_name')

    def test_keypair_delete(self):
        self._test_operator_api('keypair_delete', rpc_method='cast',
                host='fake_host', nova_keypair_id='fake_nova_keypair_id')

    def test_securitygroup_create(self):
        self._test_operator_api('securitygroup_create', rpc_method='cast',
                host='fake_host', gid='fake_gid', securitygroup_id='fake_securitygroup_id', 
                name='fake_name', securitygrouprules='fake_rules')

    def test_securitygroup_delete(self):
        self._test_operator_api('securitygroup_delete', rpc_method='cast',
                host='fake_host', neutron_securitygroup_id='fake_neutron_securitygroup_id')
    ...
    def test_network_delete(self):
        self._test_operator_api('network_delete', rpc_method='cast',
                host='fake_host', neutron_network_id='fake_neutron_network_id',
