...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'rack.best_content_type' not in self.environ:
            ...
            self.environ['rack.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['rack.best_content_type']
    ...
    def best_match_language(self):
        ...
        return self.accept_language.best_match(
                gettextutils.get_available_languages('rack'))
...
def _set_request_id_header(req, headers):
    context = req.environ.get('rack.context')
    if context:
