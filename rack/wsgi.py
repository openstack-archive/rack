...
wsgi_opts = [
    cfg.StrOpt('api_paste_config',
               ...
               help='File name for the paste.deploy config for rack-api'),
    cfg.StrOpt('wsgi_log_format',
               default='%(client_ip)s "%(request_line)s" status:'
               '%(status_code)s len: %(body_length)s time: %(wall_seconds).7f',
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = rack.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import rack.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = rack.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import rack.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `rack.exception.PasteAppNotFound`
